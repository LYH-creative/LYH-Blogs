...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/kaf-crazy.jpg",
			"assets/images/DesktopWallpaper/kaf-sakura.jpg",
			"assets/images/DesktopWallpaper/kaf-train.jpg",
			"assets/images/DesktopWallpaper/kaf-white.jpg",
			// "assets/images/DesktopWallpaper/Two- anniversary.jpeg"
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/kaf-flower.jpg",
			"assets/images/MobileWallpaper/kaf-hanabi.jpg",
			"assets/images/MobileWallpaper/kaf1.jpg",
			"assets/images/MobileWallpaper/kaf2.jpg",
			"assets/images/MobileWallpaper/kaf7years.jpg",
		],
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
